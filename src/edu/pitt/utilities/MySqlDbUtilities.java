 ...
 * @version 1.1
 */
public class MySqlDbUtilities implements DbUtilities{

    private Connection conn = null; // connection object
    private String hostName = "sis-teach-01.sis.pitt.edu:3306"; // server address + port number
    private String dbName = "yal73_bank1017"; // default database name
    private String dbUserName = "yal73"; // login name for the database server
    private String dbPassword = "3799701"; // password for the database server
